ALTER USER arthur_velemem CREATEROLE LOGIN;
ALTER USER arthur_velemem ENCRYPTED PASSWORD 'computacao@raiz';
grant all privileges on schema lojas to arthur_velemem;
